        ...
        <div className="container relative md:mt-24 mt-16">
                ...
                <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 mt-6 gap-6">
                    {blogData.slice(0,3).map((item,index) => {
                        return(
                            <div className="relative bg-white p-4 rounded-md shadow" key={index}>
                                <img src={item.image} className="rounded-md shadow" alt=""/>
                                <div className="pt-4">
                                    <div className="flex justify-between items-center">
                                        <div className="space-x-1">
                                            <Link to="" className="bg-amber-400/10 text-amber-500 text-[12px] font-semibold px-2.5 py-0.5 rounded h-5">AI</Link>
