        ...
        <section className="relative md:py-48 py-36 items-center mt-[74px] md:mx-4 md:rounded-3xl overflow-hidden">
            ...
            <div className="container relative">
                <div className="grid grid-cols-1 text-center">
                    <div className="">
                        <h4 className="font-bold lg:leading-normal leading-normal text-white text-4xl lg:text-7xl mb-5">Create AI videos <br/> from <span className="bg-gradient-to-br from-sky-400 via-blue-400 to-violet-500 text-transparent bg-clip-text"> just text.</span> </h4>
